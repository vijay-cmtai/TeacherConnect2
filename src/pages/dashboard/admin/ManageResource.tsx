// src/pages/dashboard/admin/ManageResource.tsx
...
const ManageResource = () => {
  ...
  // --- [THE FIX] ---
  // Set default values to prevent 'undefined' from being sent
  ...
  useEffect(() => {
    if (editingResource) {
      ...
      // When not editing, reset to the default values
      reset({
        title: "",
        category: "",
        content: "",
  ...
  const resetForm = () => {
    ...
    // The reset in useEffect will handle clearing the form
  };
  ...
  const handleFormSubmit: SubmitHandler<IResourceFormInput> = async (data) => {
    ...
    formData.append("isFeatured", String(data.isFeatured)); // This is now safe because of defaultValues
